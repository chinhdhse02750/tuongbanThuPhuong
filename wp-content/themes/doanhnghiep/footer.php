...
<footer class="footer">
    ...
    <div class="hotline_fixed">
        <a href="tel:0946072437"><img src="<?php echo BASE_URL; ?>/images/hotline_desk1.png"></a>
    </div>
    <div class="hotline_fixed_2">
        <a href="tel:0812394999"><img src="<?php echo BASE_URL; ?>/images/hotline_desk2.png"></a>
    </div>
</footer>
<?php wp_footer(); ?>
<!-- MESSENGER -->
