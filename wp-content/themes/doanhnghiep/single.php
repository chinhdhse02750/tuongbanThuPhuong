									...
									<div class=" col-sm-3 sidebar">
										<div class="sb_single_loop_news">
											...
											$list_post_arg = array(
												...
												'post_type' => 'post',
												'post_status' => 'publish',
												'category__not_in' => array(7,6,47,49),
											);
											...
											<div class="read_more">
												<a href="<?php echo get_category_link(3); ?>?type=moi-nhat">Xem tất cả>></a>
											</div>
										...
										<div class="sb_single_loop_most">
											...
											<div class="read_more">
												<a href="<?php echo get_category_link(3); ?>?type=xem-nhieu">Xem tất cả>></a>
											</div>
											<?php wp_reset_postdata();?>
										</div>
									</div>
